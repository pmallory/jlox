...
public class Parser  {
    ...
    private Stmt forStatement() {
        ...
        //Build a while loop statement equivalent to the for loop
        if (increment != null) {
    ...
    private Stmt printStatement() {
        Expr value = expression(); //todo move this duplicated code into statement()
    ...
    private Stmt whileStatement() {
        ...
        Expr condition = expression();
        consume(RIGHT_PAREN, "Expect ')' after while loop condition.");
        Stmt body = statement();
    ...
    private void synchronize() {
        // in the event of an error, advance to the next statement
        advance();
